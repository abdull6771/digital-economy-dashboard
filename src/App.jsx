...
function GStats() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <Card>
        <Title>IDEI vs GDEI — Why the Same Country Gets Different Scores</Title>
        <div
          style={{
            fontSize: "13px",
            lineHeight: 1.75,
        ...
        >
          ...
          IDEI benchmarks 57 OIC members against each other; the GDEI benchmarks
          240 world countries against each other. A country can therefore look
          dominant in the IDEI and merely solid in the GDEI — the raw data is
          the same, only the normalization pool changes.
        </div>
        <div
          style={{
            display: "grid",
        ...
        >
          ...
          >
            <div
              style={{ fontWeight: 700, color: "#1B5E20", marginBottom: "6px" }}
            >
              IDEI (Islamic Digital Economy Index)
            </div>
            <div style={{ fontSize: "12px", color: "#2E7D32" }}>
              Normalization pool: <strong>57 OIC members</strong>
              <br />
              P95 benchmark: the best-performing OIC country
              <br />
          ...
          >
            <div
              style={{ fontWeight: 700, color: "#0D47A1", marginBottom: "6px" }}
            >
              GDEI (Global Digital Economy Index)
            </div>
            <div style={{ fontSize: "12px", color: "#1565C0" }}>
              Normalization pool: <strong>240 world countries</strong>
              <br />
              P95 benchmark: the best-performing country on Earth
              <br />
        ...
        >
          Case study: Malaysia — #1 of 57 OIC (IDEI 82.65) → #47 of 240 global
          (GDEI 54.79)
        </div>
        <div
        ...
        <div style={{ overflowX: "auto" }}>
          ...
          >
            <thead>
              <tr style={{ borderBottom: "2px solid var(--border)" }}>
                {["Indicator", "IDEI", "GDEI", "Drop", "Root cause"].map(
                  (h) => (
                    <th
                      key={h}
                      style={{
            ...
            <tbody>
              {[
                {
                  ind: "4.5 UNESCO STEM graduates",
                  idei: 95.77,
                  gdei: 2.76,
                  cause:
                    "South Korea, Germany, Finland set the global benchmark",
                },
                {
                  ind: "4.4 WIPO ICT patents",
                  idei: 95.15,
                  gdei: 4.45,
                  cause: "US/China/Japan file millions vs Malaysia's hundreds",
                },
                {
                  ind: "3.1 Data centers (PeeringDB)",
                  idei: 100.0,
                  gdei: 26.71,
                  cause: "Brazil, India, Germany score 100 globally",
                },
                {
                  ind: "3.2 Internet exchanges (PCH)",
                  idei: 66.98,
                  gdei: 19.81,
                  cause: "Indonesia alone has far more IXP infrastructure",
                },
              ].map((r) => (
                <tr
                  key={r.ind}
        ...
        >
          ...
          <div style={{ padding: "28px 32px", background: "#fff" }}>
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              >
                8. IDEI vs GDEI — Why the same country gets different scores
              </div>
              <div
                style={{
                  fontSize: "13px",
